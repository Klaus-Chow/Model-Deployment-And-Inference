...
def repvggA0(pretrained=False, **kwargs):
    repvgg_build_func = get_RepVGG_func_by_name('RepVGG-B2g2')
...
# deploy_model = repvgg_model_convert(model,'./2.pth')
# model_dict = torch.load('./2.pth')
# model = repvgg_build_func(deploy=True)
